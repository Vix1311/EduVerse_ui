...
const API_LOGIN_URL = 'https://edu-verse-api-rho.vercel.app/api/v1/auth/login';
const API_REGISTER_URL = 'https://edu-verse-api-rho.vercel.app/api/v1/auth/register';
const API_SEND_OTP_URL = 'https://edu-verse-api-rho.vercel.app/api/v1/auth/otp';
const API_LOGIN_GOOGLE_URL = 'https://edu-verse-api-rho.vercel.app/api/v1/auth/google';
const API_LOGIN_FACEBOOK_URL = 'https://edu-verse-api-rho.vercel.app/api/v1/auth/facebook';
