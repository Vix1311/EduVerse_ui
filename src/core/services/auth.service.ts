...
const API_SEND_OTP_URL = 'http://localhost:8080/api/v1/auth/otp';
const API_LOGIN_GOOGLE_URL = 'http://localhost:8080/api/v1/auth/google';
const API_LOGIN_FACEBOOK_URL = 'http://localhost:8080/api/v1/auth/facebook';
