  ...
  async (courseId: number, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/builder/modules`,
        {
          headers: {
...
export const getModule = createAsyncThunk(
  ...
  async ({ courseId, moduleId }: { courseId: number; moduleId: number }, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/builder/modules/${moduleId}`,
        {
          headers: {
            'Content-Type': 'application/json',
            'X-API-KEY': 'NestjsSuper@Elearning$2025',
...
export const deleteModule = createAsyncThunk(
  ...
  async ({ courseId, id }: { courseId: number; id: number }, { rejectWithValue }) => {
    try {
      await axios.delete(`https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/builder/modules/${id}`, {
        headers: {
          'Content-Type': 'application/json',
          'X-API-KEY': 'NestjsSuper@Elearning$2025',
          ...headers(),
...
export const getLessons = createAsyncThunk(
  ...
  async ({ courseId, moduleId }: { courseId: number; moduleId: number }, { rejectWithValue }) => {
    try {
      const res = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/builder/modules/${moduleId}/lessons`,
        {
          headers: {
            'X-API-KEY': 'NestjsSuper@Elearning$2025',
            ...headers(),
