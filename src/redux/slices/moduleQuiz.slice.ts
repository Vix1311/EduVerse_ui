  ...
  async (
    ...
    try {
      ...
      const res = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/modules/${moduleId}/quizzes`,
        {
          headers: authHeaders(),
          params: { skip, take },
        },
...
export const fetchModuleQuizAttempt = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const res = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/modules/${moduleId}/quizzes/${quizId}/attempt`,
        {
          headers: authHeaders(),
        },
      );
