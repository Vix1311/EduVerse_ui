...
export const fetchUserProfile = createAsyncThunk('userProfile/fetch', async (_, thunkAPI) => {
  try {
    ...
    const res = await axios.get('https://edu-verse-api-rho.vercel.app/api/v1/auth/profile', {
...
export const updateUserProfile = createAsyncThunk(
  ...
  async (formData: any, thunkAPI) => {
    try {
      ...
      await axios.patch('https://edu-verse-api-rho.vercel.app/api/v1/auth/profile', payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
...
export const uploadUserImage = createAsyncThunk(
  ...
  async (file: File, thunkAPI) => {
    try {
      ...
      const res = await axios.post('https://edu-verse-api-rho.vercel.app/api/v1/auth/avatar', form, {
        headers: {
