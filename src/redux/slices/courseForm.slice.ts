...
export const listCourses = createAsyncThunk('course/list', async (_: void, { rejectWithValue }) => {
  try {
    const res = await axios.get('https://edu-verse-api-rho.vercel.app/api/v1/course', {
      headers: {
...
export const updateCourseStatus = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      await axios.patch(`https://edu-verse-api-rho.vercel.app/api/v1/course/${id}/status`, body, {
        headers: {
...
export const softDeleteCourse = createAsyncThunk(
  ...
  async ({ id }: { id: number }, { rejectWithValue }) => {
    try {
      await axios.delete(`https://edu-verse-api-rho.vercel.app/api/v1/course/${id}`, {
        headers: {
          'X-API-KEY': 'NestjsSuper@Elearning$2025',
          Authorization: `Bearer ${localStorage.getItem('access_token') || ''}`,
        },
...
export const restoreCourse = createAsyncThunk(
  ...
  async ({ id }: { id: number }, { rejectWithValue }) => {
    try {
      await axios.patch(`https://edu-verse-api-rho.vercel.app/api/v1/course/${id}/restore`, null, {
        headers: {
          'X-API-KEY': 'NestjsSuper@Elearning$2025',
          Authorization: `Bearer ${localStorage.getItem('access_token') || ''}`,
        },
...
export const createCourse = createAsyncThunk(
  ...
  async (body: CreateCoursePayload, { rejectWithValue }) => {
    try {
      const res = await axios.post('https://edu-verse-api-rho.vercel.app/api/v1/course', body, {
        headers: {
          'Content-Type': 'application/json',
          'X-API-KEY': 'NestjsSuper@Elearning$2025',
          ...headers(),
...
export const updateCourse = createAsyncThunk(
  ...
  async ({ id, body }: { id: number; body: CreateCoursePayload }, { rejectWithValue }) => {
    try {
      const res = await axios.patch(`https://edu-verse-api-rho.vercel.app/api/v1/course/${id}`, body, {
        headers: {
          'Content-Type': 'application/json',
          'X-API-KEY': 'NestjsSuper@Elearning$2025',
          ...headers(),
...
export const createTopic = createAsyncThunk(
  ...
  async ({ courseId, topicData }: CreateTopicPayload, thunkAPI) => {
    const res = await axios.post(
      `https://edu-verse-api-rho.vercel.app/api/v1/courses/${courseId}/topics`,
      topicData,
      { headers: headers() },
    );
...
export const createLesson = createAsyncThunk(
  ...
  async ({ courseId, topicId, lessonData }: CreateLessonPayload, thunkAPI) => {
    try {
      const res = await axios.post(
        `https://edu-verse-api-rho.vercel.app/api/v1/courses/${courseId}/topics/${topicId}/lessons`,
        lessonData,
        { headers: headers() },
      );
...
export const deleteLesson = createAsyncThunk(
  ...
  async (
    ...
    try {
      await axios.delete(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/builder/modules/${moduleId}/lessons/${lessonId}`,
        {
          headers: {
            'X-API-KEY': 'NestjsSuper@Elearning$2025',
            ...headers(),
...
export const uploadLessonPdf = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      await axios.post(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/builder/modules/${moduleId}/lessons/${lessonId}/pdf`,
        formData,
        {
          headers: {
            ...headers(),
