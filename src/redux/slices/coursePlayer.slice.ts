...
export const fetchCourseDetail = createAsyncThunk(
  ...
  async (courseId: string, { rejectWithValue, dispatch }) => {
    try {
      ...
      const studyRes = await axios.get(`https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/study`, {
        headers: authHeaders(),
      });
      ...
      const modulesRes = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/course/${courseId}/modules`,
        {
          headers: authHeaders(),
      ...
      for (const module of rawModules) {
        ...
        const lessonsRes = await axios.get(
          `https://edu-verse-api-rho.vercel.app/api/v1/study/modules/${moduleId}/lessons`,
          {
            headers: authHeaders(),
            params: { skip: 0, take: 100 },
          },
        ...
        for (const l of rawLessons) {
          ...
          const detailRes = await axios.get(
            `https://edu-verse-api-rho.vercel.app/api/v1/study/lessons/${lessonId}`,
            { headers: authHeaders() },
          );
...
export const fetchQuiz = createAsyncThunk(
  ...
  async (courseId: string, { rejectWithValue }) => {
    try {
      const token = localStorage.getItem('access_token');
      const res = await axios.get(`https://edu-verse-api-rho.vercel.app/api/v1/courses/my-courses/${courseId}`, {
  ...
  async (
    ...
    try {
      ...
      const res = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/courses/${courseId}/quizzes/${quizId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  async (
    ...
    try {
      ...
      const res = await axios.post(
        `https://edu-verse-api-rho.vercel.app/api/v1/courses/${payload.courseId}/quizzes/${payload.quizId}/submit`,
...
export const fetchLessonComments = createAsyncThunk(
  ...
  async (courseId: string, { rejectWithValue, dispatch }) => {
    try {
      dispatch(showLoading());
      const token = localStorage.getItem('access_token');
      const res = await axios.get(`https://edu-verse-api-rho.vercel.app/api/v1/courses/${courseId}/comments`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      return res.data?.data;
    } catch (error: any) {
...
export const submitReview = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const token = localStorage.getItem('access_token');
      const res = await axios.post(
        `https://edu-verse-api-rho.vercel.app/api/v1/courses/${payload.courseId}/reviews`,
        payload,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
...
export const submitLessonComment = createAsyncThunk(
  ...
  async (
    ...
    try {
      const token = localStorage.getItem('access_token');
      const res = await axios.post(
        `https://edu-verse-api-rho.vercel.app/api/v1/comments/courses/${payload.courseId}/lessons/${payload.lessonId}`,
        {
...
export const deleteLessonComment = createAsyncThunk(
  ...
  async (commentId: string, { rejectWithValue }) => {
    try {
      const token = localStorage.getItem('access_token');
      await axios.delete(`https://edu-verse-api-rho.vercel.app/api/v1/comments/${commentId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
...
export const submitFeedback = createAsyncThunk(
  ...
  async (payload: { courseId: string; content: string }, { rejectWithValue }) => {
    try {
      const token = localStorage.getItem('access_token');
      await axios.post(
        `https://edu-verse-api-rho.vercel.app/api/v1/feedbacks/course/${payload.courseId}`,
  ...
  async (courseId: string, { rejectWithValue, dispatch }) => {
    try {
      ...
      const lessonRes = await axios.get(
        `https://edu-verse-api-rho.vercel.app/api/v1/courses/my-courses/${courseId}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
      ...
      for (const lessonId of allLessons) {
        const res = await axios.get(`https://edu-verse-api-rho.vercel.app/api/v1/comments/lessons/${lessonId}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  async (courseId: string, { rejectWithValue }) => {
    try {
      ...
      const commentFetches = allLessons.map(async ({ lesson }: { lesson: any }) => {
        try {
          const res = await axios.get(
            `https://edu-verse-api-rho.vercel.app/api/v1/comments/lessons/${lesson._id}`,
            { headers: { Authorization: `Bearer ${token}` } },
          );
