...
export const fetchCategories = createAsyncThunk(
  ...
  async (params: Partial<ListParams> | undefined, { getState, rejectWithValue }) => {
    try {
      ...
      const res = await axios.get('https://edu-verse-api-rho.vercel.app/api/v1/category', {
        params: { skip, take },
        headers,
      });
...
export const createCategory = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const res = await axios.post('https://edu-verse-api-rho.vercel.app/api/v1/category', data, {
...
export const updateCategory = createAsyncThunk(
  ...
  async ({ id, data }: { id: string; data: any }, { rejectWithValue }) => {
    try {
      ...
      const res = await axios.patch(`https://edu-verse-api-rho.vercel.app/api/v1/category/${id}`, body, {
        headers: buildHeaders(),
      });
...
export const deleteCategory = createAsyncThunk(
  ...
  async (id: string, { rejectWithValue }) => {
    try {
      await axios.delete(`https://edu-verse-api-rho.vercel.app/api/v1/category/${id}`, {
        headers: buildHeaders(),
      });
