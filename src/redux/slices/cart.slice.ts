...
export const addCourseToCart = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      try {
        const res = await axios.post('https://edu-verse-api-rho.vercel.app/api/v1/cart', body1, { headers });
        ...
        const res2 = await axios.post('https://edu-verse-api-rho.vercel.app/api/v1/cart', body2, { headers });
        window.dispatchEvent(new Event('cartUpdated'));
        return String(cidNum);
      }
    } catch (error: any) {
...
export const clearCartOnServer = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const token = localStorage.getItem('access_token');
      if (!token) throw new Error('Unauthorized');
      await axios.delete('https://edu-verse-api-rho.vercel.app/api/v1/cart', {
        headers: { Authorization: `Bearer ${token}` },
      });
      return [];
    } catch (error: any) {
...
export const buyNowCourse = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const res = await axios.post('https://edu-verse-api-rho.vercel.app/api/v1/orders/buy-now', body, {
        headers,
      });
...
export const checkMomoPayment = createAsyncThunk(
  ...
  async (_, { rejectWithValue, dispatch }) => {
    try {
      ...
      const res = await axios.get('https://edu-verse-api-rho.vercel.app/api/v1/orders/momo/return', {
        headers,
      });
